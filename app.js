    ...
    const htmlParaImprimir = `
                ...
                <head>
                    ...
                    <style>
                        ...
                        .secao { border: 1px solid #ccc; border-radius: 8px; padding: 15px; margin-bottom: 15px; page-break-inside: avoid; }
                        ...
                        .item-dado p { margin: 2px 0; }
                        .item-dado .label { font-weight: 500; color: #333; }
                        .item-dado .value { color: #666; }
                        ...
                        .texto-explicativo { margin-top: 20px; font-size: 0.9em; line-height: 1.6; }
                        .footer {
                            text-align: center;
                            margin-top: 15px;
                            font-size: 0.7em;
                ...
                <body>
                    ...
                    <div class="secao">
                        ...
                        <div class="grid-dados">
                            <div class="item-dado"><p><span class="label">Valor das Parcelas:</span> <span class="value">${valorParcelas}</span></p></div>
                            <div class="item-dado"><p><span class="label">Total de Parcelas:</span> <span class="value">${totalParcelas}</span></p></div>
                            <div class="item-dado"><p><span class="label">Parcelas Pagas:</span> <span class="value">${parcelasPagas}</span></p></div>
                            <div class="item-dado"><p><span class="label">Meses em Atraso:</span> <span class="value">${mesesAtraso}</span></p></div>
                        </div>
                    </div>
                    ...
                    <div class="secao">
                        ...
                        <div class="grid-dados">
                            <div class="item-dado"><p><span class="label">Valor Total do Contrato:</span> <span class="value">${valorTotalContrato}</span></p></div>
                            <div class="item-dado"><p><span class="label">Dívida em Aberto:</span> <span class="value">${dividaEmAberto}</span></p></div>
                            <div class="item-dado"><p><span class="label">Valor em Atraso:</span> <span class="value">${valorTotalAtraso}</span></p></div>
                            <div class="item-dado"><p><span class="label">Classificação da Dívida:</span> <span class="value">${classificacao}</span></p></div>
                            <div class="item-dado" style="grid-column: span 2;"><p><span class="label">Valor Total Provisionado pelo Banco:</span> <span class="value">${valorProvisionado}</span></p></div>
                        </div>
                    ...
                    <div class="secao">
                         ...
                         <div class="texto-explicativo">
                            <p><i>Os valores apresentados aqui são apenas estimativas.</i></p>
                            ${textoExplicativo}
                         </div>
                    </div>
